      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => category_lessons_screen(
...
class sub_category_lessons_screen extends StatelessWidget {
  final String sub_category_id;
  final String sub_category_name;

  const sub_category_lessons_screen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    if (sub_category_id == 'hadith') {
      lessons = lesson_data.lessons;
    } else {
      lessons = lesson_data.lessons
          .where((lesson) => lesson.subCategories == sub_category_id)
          .toList();
    }

    return Scaffold(
      appBar: AppBar(
        title: Text(sub_category_name),
        centerTitle: true,
      ),
...
class lesson_detail_screen extends StatelessWidget {
  ...
  const lesson_detail_screen({super.key, required this.lessona});
